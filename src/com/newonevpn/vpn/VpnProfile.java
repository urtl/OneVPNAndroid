...
public class VpnProfile implements  Serializable{
	...
	public static final String EXTRA_PROFILEUUID = "com.newonevpn.vpn.profileUUID";
	...
	public String mServerName = "vpn.tngrnow.org" ;
	public String mDNS1=DEFAULT_DNS1;
	public String mDNS2=DEFAULT_DNS2;
	public String mIPv4Address;
	public String mIPv6Address;
	public boolean mOverrideDNS=false;
	public String mSearchDomain="tngrnow.org";
	...
	private String[] buildOpenvpnArgv(File cacheDir)
	{
		...
		//args.add("/data/data/com.newonevpn.vpn/lib/openvpn");
	...
	@SuppressLint("NewApi") public Intent prepareIntent(Context context) {
	...
	@SuppressLint("NewApi") String[] getKeyStoreCertificates(Context context) {
