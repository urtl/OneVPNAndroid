...
import com.newonevpn.vpn.core.OpenVPN.LogItem;
import com.newonevpn.vpn.core.OpenVPN.LogListener;
import com.newonevpn.vpn.core.OpenVPN.StateListener;
import com.newonevpn.vpn.core.OpenVpnService;
import com.newonevpn.vpn.core.OpenVpnService.LocalBinder;
    ...
    private void showDisconnectDialog(final OpenVpnService service) {
        ...
        builder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                //	NetSee.ed.putString("flag", "false");
                //	NetSee.ed.commit();
                }
            }
        });
