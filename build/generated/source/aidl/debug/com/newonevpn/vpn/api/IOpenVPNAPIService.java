 ...
 * Original file: /Users/intermarketsecurities/Desktop/Projects/Android/OneVPN/src/com/newonevpn/vpn/api/IOpenVPNAPIService.aidl
 */
package com.newonevpn.vpn.api;
public interface IOpenVPNAPIService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.newonevpn.vpn.api.IOpenVPNAPIService
{
private static final java.lang.String DESCRIPTOR = "com.newonevpn.vpn.api.IOpenVPNAPIService";
...
/**
 * Cast an IBinder object into an com.newonevpn.vpn.api.IOpenVPNAPIService interface,
 * generating a proxy if needed.
 */
public static com.newonevpn.vpn.api.IOpenVPNAPIService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.newonevpn.vpn.api.IOpenVPNAPIService))) {
return ((com.newonevpn.vpn.api.IOpenVPNAPIService)iin);
}
return new com.newonevpn.vpn.api.IOpenVPNAPIService.Stub.Proxy(obj);
}
...
java.util.List<com.newonevpn.vpn.api.APIVpnProfile> _result = this.getProfiles();
...
{
data.enforceInterface(DESCRIPTOR);
com.newonevpn.vpn.api.IOpenVPNStatusCallback _arg0;
_arg0 = com.newonevpn.vpn.api.IOpenVPNStatusCallback.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements com.newonevpn.vpn.api.IOpenVPNAPIService
{
...
@Override public java.util.List<com.newonevpn.vpn.api.APIVpnProfile> getProfiles() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<com.newonevpn.vpn.api.APIVpnProfile> _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getProfiles, _data, _reply, 0);
_reply.readException();
_result = _reply.createTypedArrayList(com.newonevpn.vpn.api.APIVpnProfile.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
/**
      ...
      */
@Override public void registerStatusCallback(com.newonevpn.vpn.api.IOpenVPNStatusCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public void unregisterStatusCallback(com.newonevpn.vpn.api.IOpenVPNStatusCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public java.util.List<com.newonevpn.vpn.api.APIVpnProfile> getProfiles() throws android.os.RemoteException;
...
/**
      * Registers to receive OpenVPN Status Updates
      */
public void registerStatusCallback(com.newonevpn.vpn.api.IOpenVPNStatusCallback cb) throws android.os.RemoteException;
/**
     * Remove a previously registered callback interface.
     */
public void unregisterStatusCallback(com.newonevpn.vpn.api.IOpenVPNStatusCallback cb) throws android.os.RemoteException;
}
